...
import Server.model.card.SpellTrapCards.effects.AddEffects;
...
public class SpellTrapCard extends Card {
    ...
    public static String[][] allDataAboutSpellTrap() {
        ...
        try {
            reader = new CSVReader(new FileReader("src/main/resources/Server/controller/database/SpellTrap.csv"));
            String[] nextLine;
            int a = 0, b = 0;
